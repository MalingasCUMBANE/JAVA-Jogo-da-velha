...
public class JodoDaVelha extends JFrame {

    JButton[] bt = new JButton[9];
    JButton newPlay = new JButton("Novo jogo");
    JButton zerar = new JButton("Zerar pontos");
    ...
    public JodoDaVelha() {
        ...
        add(newPlay);
        add(zerar);
        newPlay.setBounds(410, 130, 140, 30);
